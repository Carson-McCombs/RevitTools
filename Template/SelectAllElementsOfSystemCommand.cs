...
namespace CarsonsAddins
{
    ...
    class SelectAllElementsOfSystemCommand : IExternalCommand, ISettingsComponent
    {
        ...
        public Result Execute(UIApplication uiapp)
        {
            ...
            try
            {
                Reference elementReference = uidoc.Selection.PickObject(ObjectType.Element, new SelectionFilter_PipingElements(true,true,true,true), "Please select a Piping Element.");
